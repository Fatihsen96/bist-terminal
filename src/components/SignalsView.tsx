...
export const SignalsView: React.FC<SignalsViewProps> = ({ onSelectStock, onOpenDetailModal }) => {
  ...
  return (
    /* h-screen ve overflow-hidden sayesinde dış kapsayıcı taşmaz, haberler hep görünür kalır */
    <div className="flex-1 flex flex-col h-full overflow-hidden text-[#dee3e8] select-none bg-[#0a0b0d]">
      
      {/* ÜST İÇERİK BÖLGESİ (Dikey Kaydırılabilir Scroll Alanı) */}
