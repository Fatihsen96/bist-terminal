...
import { TrendingUp, AlertTriangle, Info, BarChart2, Radio } from 'lucide-react';
      ...
      <div className="space-y-3 flex-1 overflow-y-auto custom-scrollbar pr-1">
        {newsItems.map((item) => (
          <div
            ...
            className="flex gap-3 items-start border-b border-[#1f1f2e]/60 pb-3 hover:bg-[#171c20]/50 p-1.5 rounded transition-colors cursor-pointer group"
          >
            ...
            <div className="flex flex-col flex-1">
              <div className="flex justify-between items-baseline">
                <span className="text-[10px] font-mono font-bold text-[#38bdf8] group-hover:underline">
                  ${item.ticker}
                </span>
